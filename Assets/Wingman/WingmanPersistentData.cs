...
namespace WingmanInspector {
    ...
    public class WingmanPersistentData : ScriptableObject {
        ...
        [SerializeField] private List<ulong> indexLookUp = new List<ulong>();
        ...
        private class SelectionData {
            public List<ulong> selectionList = new List<ulong>();
        }

        public List<ulong> SelectedCompIds(Object obj) {
        ...
        public void AddDataForContainer(Object obj) {
            ulong id = EntityId.ToULong(obj.GetEntityId());
        ...
        private bool GetObjectIndex(Object obj, out int index) {
            index = indexLookUp.BinarySearch(EntityId.ToULong(obj.GetEntityId()));
            return index >= 0;
        }
