...
namespace VHierarchy
{
    class VHierarchyMenu
    {
        ...
        public static bool focusBackEnabled { get => EditorPrefsCached.GetBool("vHierarchy-focusBackEnabled", true); set => EditorPrefsCached.SetBool("vHierarchy-focusBackEnabled", value); }
        public static bool duplicateHoveredEnabled { get => EditorPrefsCached.GetBool("vHierarchy-duplicateHoveredEnabled", true); set => EditorPrefsCached.SetBool("vHierarchy-duplicateHoveredEnabled", value); }
        public static bool parentUnderHoveredEnabled { get => EditorPrefsCached.GetBool("vHierarchy-parentUnderHoveredEnabled", true); set => EditorPrefsCached.SetBool("vHierarchy-parentUnderHoveredEnabled", value); }
        ...
        const string focusBack = dir + "Shift-F to go back";
        const string duplicateHovered = dir + "Ctrl-D to duplicate hovered";
        const string parentUnderHovered = dir + "G to parent selected under hovered";
        ...
        [MenuItem(focusBack, false, 109)] static void fdsfds_1() => focusBackEnabled = !focusBackEnabled;
        [MenuItem(focusBack, true, 109)] static bool fdsfds_2() { Menu.SetChecked(focusBack, focusBackEnabled); return !pluginDisabled; }

        [MenuItem(duplicateHovered, false, 110)] static void fdsfds_3() => duplicateHoveredEnabled = !duplicateHoveredEnabled;
        [MenuItem(duplicateHovered, true, 110)] static bool fdsfds_4() { Menu.SetChecked(duplicateHovered, duplicateHoveredEnabled); return !pluginDisabled; }

        [MenuItem(parentUnderHovered, false, 111)] static void fdsfds_5() => parentUnderHoveredEnabled = !parentUnderHoveredEnabled;
        [MenuItem(parentUnderHovered, true, 111)] static bool fdsfds_6() { Menu.SetChecked(parentUnderHovered, parentUnderHoveredEnabled); return !pluginDisabled; }
