...
namespace VHierarchy.Libs
{
    public static class VUtils
    {
        ...
        public struct GlobalID : System.IEquatable<GlobalID>
        {
            ...
            public int GetObjectInstanceId() => GlobalObjectIdentifierToInstanceIDSlow_Safe(globalObjectId);
        ...
        public static GlobalID[] GetGlobalIDs(this IEnumerable<int> instanceIds)
        {
            ...
            GetGlobalObjectIdsSlow_Safe(instanceIds.ToArray(), unityGlobalIds);
        ...
        public static int[] GetObjectInstanceIds(this IEnumerable<GlobalID> globalIDs)
        {
            ...
            GlobalObjectIdentifiersToInstanceIDsSlow_Safe(goids, iids);
        ...
        public static class EditorUtils
        {
            ...
            public static void OpenFolder(string path)
            {
                ...
                m_ListAreaState.GetType().GetField("m_SelectedInstanceIDs").SetValue(m_ListAreaState, new List<int> { folder.GetInstanceID_Safe() });
        ...
        #region Unity 6 Obsolete API Wrappers

        public static int GetInstanceID_Safe(this UnityEngine.Object obj)
        {
            if (!obj) return 0;
            if (_getInstanceId == null) _getInstanceId = (System.Func<UnityEngine.Object, int>)System.Delegate.CreateDelegate(typeof(System.Func<UnityEngine.Object, int>), typeof(UnityEngine.Object).GetMethod("GetInstanceID"));
            return _getInstanceId(obj);
        }
        static System.Func<UnityEngine.Object, int> _getInstanceId;

        public static UnityEngine.Object InstanceIDToObject_Safe(int id)
        {
            if (_instanceIDToObject == null) _instanceIDToObject = (System.Func<int, UnityEngine.Object>)System.Delegate.CreateDelegate(typeof(System.Func<int, UnityEngine.Object>), typeof(EditorUtility).GetMethod("InstanceIDToObject"));
            return _instanceIDToObject(id);
        }
        static System.Func<int, UnityEngine.Object> _instanceIDToObject;

        public static UnityEngine.Object Resources_InstanceIDToObject_Safe(int id)
        {
            if (_resInstanceIDToObject == null) _resInstanceIDToObject = (System.Func<int, UnityEngine.Object>)System.Delegate.CreateDelegate(typeof(System.Func<int, UnityEngine.Object>), typeof(UnityEngine.Resources).GetMethod("InstanceIDToObject", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static));
            return _resInstanceIDToObject(id);
        }
        static System.Func<int, UnityEngine.Object> _resInstanceIDToObject;

        public static int GlobalObjectIdentifierToInstanceIDSlow_Safe(GlobalObjectId id)
        {
            if (_goIdToInstId == null) _goIdToInstId = (System.Func<GlobalObjectId, int>)System.Delegate.CreateDelegate(typeof(System.Func<GlobalObjectId, int>), typeof(GlobalObjectId).GetMethod("GlobalObjectIdentifierToInstanceIDSlow"));
            return _goIdToInstId(id);
        }
        static System.Func<GlobalObjectId, int> _goIdToInstId;

        public static void GetGlobalObjectIdsSlow_Safe(int[] instanceIds, GlobalObjectId[] globalObjectIds)
        {
            if (_getGoIds == null) _getGoIds = (System.Action<int[], GlobalObjectId[]>)System.Delegate.CreateDelegate(typeof(System.Action<int[], GlobalObjectId[]>), typeof(GlobalObjectId).GetMethod("GetGlobalObjectIdsSlow", new Type[] { typeof(int[]), typeof(GlobalObjectId[]) }));
            _getGoIds(instanceIds, globalObjectIds);
        }
        static System.Action<int[], GlobalObjectId[]> _getGoIds;

        public static void GlobalObjectIdentifiersToInstanceIDsSlow_Safe(GlobalObjectId[] globalObjectIds, int[] instanceIds)
        {
            var newMethod = typeof(GlobalObjectId).GetMethod(
            ...
            if (newMethod != null)
            {
                var entityIds = new UnityEngine.EntityId[instanceIds.Length];
                newMethod.Invoke(null, new object[] { globalObjectIds, entityIds });

                var type = typeof(UnityEngine.EntityId);
                var propInterop = type.GetProperty("InteropId", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
                var getRawData = type.GetMethod("GetRawData", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);

                for (int i = 0; i < entityIds.Length; i++)
                {
                    if (propInterop != null)
                        instanceIds[i] = (int)(uint)(ulong)propInterop.GetValue(entityIds[i]);
                    else if (getRawData != null)
                        instanceIds[i] = (int)(uint)(ulong)getRawData.Invoke(entityIds[i], null);
                    else
                        instanceIds[i] = entityIds[i].GetHashCode();
                }

                return;
            }

            // Для старых версий Unity — через рефлексию чтобы избежать CS0619
            var oldMethod = typeof(GlobalObjectId).GetMethod(
                "GlobalObjectIdentifiersToInstanceIDsSlow",
                System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static,
                null,
                new System.Type[] { typeof(GlobalObjectId[]), typeof(int[]) },
                null
            );
            oldMethod?.Invoke(null, new object[] { globalObjectIds, instanceIds });
        }
    ...
    public static class VGUI
    {
        ...
        {
            if (!curEvent.isRepaint) return;
            if (_mi_GUIClip_UnclipToWindow == null || _pi_GUIView_current == null || _mi_GUIView_MarkHotRegion == null) return;
